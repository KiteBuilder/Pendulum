#ifndef MPU_COMMANDS_H_
#define MPU_COMMANDS_H_

#define MPU6050_I2C_ADDR            (0x68 << 1) //when ADO pin pulled low, 0x69 -  when ADO pin pulled high

// MPU Register's Addresses
...
static const float gyro_sens_table[] = {131.0, 65.5, 32.8, 16.4};
...
static const uint16_t acc_sens_table[] = {16384, 8192, 4096, 2048};
 ...
 */
#define get_int16_val_bigend(buf, idx) ( (int16_t)( ((uint8_t)buf[2 * idx] << 8) | buf[2 * idx + 1] ) )
